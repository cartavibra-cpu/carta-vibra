      ...
      >
        <div
          style={{
            ...
            inset: '20%',
            borderRadius: '50%',
            background: 'conic-gradient(from 200deg,#5E2EFF,#00D4FF,#6EF3B2,#5E2EFF)',
      ...
      {glow && (
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(0,212,255,.4), rgba(94,46,255,.28) 45%, transparent 70%)',
            filter: 'blur(16px)',
      ...
      >
        <div
          style={{
            ...
            inset: '20%',
            borderRadius: '50%',
            background: 'conic-gradient(from 210deg,#5E2EFF,#00D4FF,#6EF3B2,#00D4FF,#5E2EFF)',
