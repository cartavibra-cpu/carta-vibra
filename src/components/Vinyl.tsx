      ...
      >
        <div
          style={{
            ...
            inset: '20%',
            borderRadius: '50%',
            background: 'conic-gradient(from 200deg,#b14cff,#ff4db0,#ff8a5c,#b14cff)',
      ...
      {glow && (
        <div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(177,76,255,.42), rgba(255,77,176,.26) 45%, transparent 70%)',
            filter: 'blur(16px)',
      ...
      >
        <div
          style={{
            ...
            inset: '20%',
            borderRadius: '50%',
            background: 'conic-gradient(from 210deg,#b14cff,#ff4db0,#ff8a5c,#ff4db0,#b14cff)',
